...
vec3_t	Model::anorms[ NUMVERTEXNORMALS ] = { normalVectors };

// precalculated dot product results
float	Model::anorms_dots[ SHADEDOT_QUANT ][256] = { dotProdVectors };


static float	*shadedots = Model::anorms_dots[0];
...
bool Model::LoadModel( const char *filename )
{
	...
	// verify that this is an MD2 file
...
bool Model::LoadSkin( const char *filename )
{
...
void Model::ProcessLighting( void )
{
...
void Model::Interpolate( vec3_t *vertlist )
{
